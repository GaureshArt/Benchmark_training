        ...
        <div className="w-full h-auto flex justify-center items-center">
            <form className="w-1/3 h-1/2 border p-5 flex flex-col gap-3 rounded border-zinc-400" onSubmit={handleSubmit}>
                ...
                <div className="grid w-full max-w-sm items-center gap-1.5">
                        ...
                        <Input type="text" id="title" placeholder="title" defaultValue={data!.title}  onChange={handleFormData}/>
                    </div>
                    <div className="grid w-full max-w-sm items-center gap-1.5">
                        <Label htmlFor="price">Price</Label>
                        <Input type="number" id="price" placeholder="price" defaultValue={data!.price} onChange={handleFormData}/>
                    </div>
                </div>
                <div>
                    <Label htmlFor="description">Description</Label>
                    <Textarea placeholder="Write Description about product" id="description" defaultValue={data!.description} onChange={handleFormData}/>
                </div>
                <div className="flex justify-center gap-4">
                <div className="grid w-full max-w-sm items-center gap-1.5">
                        <Label htmlFor="category">Category</Label>
                        <Input type="text" id="category" placeholder="category" defaultValue={data!.category} onChange={handleFormData}/>
                    </div>
                    <div className="grid w-full max-w-sm items-center gap-1.5">
                        <Label htmlFor="image">ImageUrl</Label>
                        <Input type="text" id="image" placeholder="image" defaultValue={data!.image} onChange={handleFormData} />
                    </div>
                </div>
