...
const quantityValue =  document.querySelector('.quantity-value') as HTMLDivElement;
...
quantityDiv.addEventListener('click',(e:Event)=>{
 ...
 const handleAddCart = async (prodcard:HTMLDivElement)=>{
     const quantityValue = +(prodcard.querySelector('.quantity-value') as HTMLSpanElement).innerHTML;
