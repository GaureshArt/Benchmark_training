...
const imageSlider = document.querySelector('.imageSlider') as HTMLDivElement;
const getDummyLoginBtn = document.querySelector('.get-dummy-login') as HTMLButtonElement;
const dummyLoginBtn = document.querySelector('.dummy-login') as HTMLButtonElement;
